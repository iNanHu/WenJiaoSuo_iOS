//
//  WJSURLSessionWrapperOperation.m
//  WenminYizhangtong
//
...
@interface WJSURLSessionWrapperOperation () {
...
@implementation WJSURLSessionWrapperOperation

+ (instancetype)operationWithURLSessionTask:(NSURLSessionTask*)task {
    WJSURLSessionWrapperOperation* operation = [WJSURLSessionWrapperOperation new];
    operation.task = task;
    return operation;
}
